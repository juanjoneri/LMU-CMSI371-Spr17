...
(() => {
    ...
    $("#apply-refresh-button").click(function () {
        location.reload();
    });

    // Set a little event handler to apply the filter.
    $("#apply-filter1-button").click(function () {
        // Filter time.
    ...
    $("#apply-filter2-button").click(function () {
        // Filter time.
        renderingContext.putImageData(
            NanoshopNeighborhood.applyFilter(
                renderingContext,
    ...
    $("#apply-filter3-button").click(function () {
        // Filter time.
        renderingContext.putImageData(
            NanoshopNeighborhood.applyFilter(
                renderingContext,
    ...
    $("#apply-filter4-button").click(function () {
        // Filter time.
        renderingContext.putImageData(
            NanoshopNeighborhood.applyFilter(
                renderingContext,
                renderingContext.getImageData(0, 0, canvas.width, canvas.height),
                NanoshopNeighborhood.granulate
            ),
            0, 0
        );
    });
    $("#apply-filter5-button").click(function () {
        // Filter time.
        renderingContext.putImageData(
            NanoshopNeighborhood.applyFilter(
                renderingContext,
                renderingContext.getImageData(0, 0, canvas.width, canvas.height),
                NanoshopNeighborhood.colors
            ),
            0, 0
        );
    });
